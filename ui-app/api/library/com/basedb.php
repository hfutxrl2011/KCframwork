...
require_once (dirname(__FILE__) . '/mysqlmanager.php');

class Api_Com_BaseDb
{
	...
	public function getConnection($throw = true, $force = false)
	{
		...
		self::$_dbObj = new MysqlManager();
		if(false === self::$_dbObj->fetchMysqlHandler(0, 0))
		{
			$tag = 0;
