<?php
/* Copyright(C)
* mobile product department of youzu 
* All right reserved
*/
/**
* @file Email.php
...
if(__FILE__ === realpath($_SERVER['SCRIPT_FILENAME'])){
	$mail = new EMail();
	$mail->setServer("mail.uuzu.com", "icafe", "HOg1SVfmSyrsZzJn8W06");
	$mail->setFrom("icafe@uuzu.com");
	$mail->setReceiver("hustwujing@163.com");
	$mail->setCc("hustwujing@163.com");
	//$mail->setBcc("XXXXX");
	//$mail->addAttachment("XXXX"); //添加附件，多个附件，调用多次
	$mail->setMail("测试邮件的标题", "测试邮件的内容"); //设置邮件主题、内容
 	$mail->sendMail(); //发送	
}
?>
